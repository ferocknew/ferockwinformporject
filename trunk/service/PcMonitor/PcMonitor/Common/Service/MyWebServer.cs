...
namespace PcMonitor.Common.Service
{
    class MyWebServer
    {
        ...
        private int port = 11800; // 选者任何闲置端口
        ...
        public void SendHeader(string sHttpVersion, string sMIMEHeader, int iTotBytes, string sStatusCode, ref Socket mySocket)
        {
            ...
            sBuffer = sBuffer + "Connection: Keep-Alive\r\n";
            sBuffer = sBuffer + "Accept-Ranges: bytes\r\n";
            sBuffer = sBuffer + "Etag:\"555c1bb382dacb1:0\"\r\n";
            sBuffer = sBuffer + "Date:" + DateTime.Now.GetDateTimeFormats('r')[0].ToString()+ "\r\n";
        ...
        public void StartListen()
        {
            ...
            String sLocalDir;
            /////////////////////////////////////注意设定你自己的虚拟目录/////////////////////////////////////
            String sMyWebServerRoot = @"D:\www\jsonp\"; //设置你的虚拟目录
            //////////////////////////
            ...
            while (true)
            {
                ...
                if (mySocket.Connected)
                {
                    ...
                    /////////////////////////////////////////////////////////////////////
                    String sMimeType = "text/javascript";
